...
def show_info(config_path: Path, config: dict[str, Any], instance: dict[str, Any]) -> None:
    ...
    print(f"  ./ardr.py service status --instance {name}")
    print(f"  ./ardr.py service logs --instance {name} --follow")
    print(f"  sudo ./ardr.py service restart --instance {name}")
    print(f"  ./ardr.py ports --instance {name}")
    print(f"  ./ardr.py mods list --instance {name}")
    print(f"  ./ardr.py backup create --instance {name}")
    print()
