...
from ..core.network import detect_host_ip
from ..core.ports import next_port_pair
...
def _server_block(name: str, server: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "publicAddress": prompt("Public IP/domain for direct connect", str(server.get("publicAddress", "")) or detected_host),
    }
